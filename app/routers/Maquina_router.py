...
router = APIRouter(
    prefix="/api/v1/maquinas", # 👈 Ajustado al prefijo oficial de tu API
...
async def listar_todas_las_maquinas(
    ...
    """
    Permite obtener el listado completo de máquinas del gimnasio con sus descripciones y estados operativos.
    """
    servicio = Maquina_Service(session)
